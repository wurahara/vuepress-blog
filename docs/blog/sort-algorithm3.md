...
![数据结构](http://images.herculas.cn/image/blog/algorithms/sort3/array%20implementation.png)
...
![上浮](http://images.herculas.cn/image/blog/algorithms/sort3/promotion.png)
...
![下沉](http://images.herculas.cn/image/blog/algorithms/sort3/demotion.png)
...
![堆的构造](http://images.herculas.cn/image/blog/algorithms/sort3/construction.png)

#### 堆的排序

将堆的最大元素删除，然后将数组末尾的元素交换到根部，对堆进行下沉排序。示意图如下：

![堆的下沉排序](http://images.herculas.cn/image/blog/algorithms/sort3/sortdown.png)
